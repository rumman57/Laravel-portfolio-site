 ...
 <main class="content">
	...
	<div class="pull-left">
	    <div class="dropdown bldb form-wrapper1 ">
	      <button class="dropdown-toggle" type="button" data-toggle="dropdown">Posts By Category
	...
	<div class="blogsearch pull-right">
	  <form class="form-wrapper cf" id="formsid" method="POST" action="{{route('blog.search')}}">   {{ csrf_field() }}
