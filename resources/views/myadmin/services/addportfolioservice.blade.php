  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Portfolio Services</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              <small>Below add the Portfolio Services</small>
       ...
       <form action="{{route('portfolo-services.store')}}" method="post">
       {{csrf_field()}}
         <div class="row">
         <div class="col-xs-7">
         ...
         <div class="col-xs-7">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Data Type" name="data_type">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          </div>
         </div>
